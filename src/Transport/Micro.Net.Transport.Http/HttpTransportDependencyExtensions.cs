...
namespace Micro.Net.Transport.Http
{
    ...
    {
        public static IMicroConfigurer UseHttpReceiver(this IMicroConfigurer cfgr, Action<HttpReceiverConfiguration> rcvrCfg)
        {
        ...
        public static IMicroConfigurer UseHttpDispatcher(this IMicroConfigurer cfgr, Action<HttpDispatcherConfiguration> dsptCfg)
        {
